...
def build_intraday_context_summary(context, dry_run=False):
    return {
...
def print_intraday_context_summary(summary):
...
def run_intraday_pipeline(dry_run=False):
    ...
    summary = build_intraday_context_summary(context, dry_run=dry_run)
    print_intraday_context_summary(summary)
