...
Future phases may add VM-side validation execution, approval-state handling, and carefully scoped automation, but each addition should remain scoped, reviewable, and guarded by explicit safety rules.
