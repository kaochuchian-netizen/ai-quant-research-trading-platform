...
def main():
    ...
    checks={"valid_opportunity":good["eligibility"]["top_opportunity"] and good["eligibility"]["actionable"] and good["trade_plan"]["status"]=="active","tsm_demoted":not tsm["eligibility"]["top_opportunity"] and tsm["eligibility"]["no_trade"] and tsm["trade_plan"]["status"]=="no_trade","googl_no_active_plan":googl["trade_plan"]["entry"] is None and googl["trade_plan"]["observation_zone"] is not None,"count_list_parity":summary["top_opportunity_count"]==1 and summary["groups"]["top_opportunity"]==["NVDA"],"exclusivity":not validate_premarket_contract(cards,summary)}
