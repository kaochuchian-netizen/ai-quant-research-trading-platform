...
def validate(section: str = "all") -> dict:
    ...
    checks = {
        ...
        "raw_representation_absent": not any(token in public for token in ("{'high':", "available", "unclassified", "Canonical Decision V1", "Confirmed setups", "Failed gaps", "Still actionable", "setup 是否")),
