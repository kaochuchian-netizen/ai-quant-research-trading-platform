...
from app.reports.window_report_contract import all_window_report_contracts, get_window_report_contract, no_send_matrix
...
def validate() -> dict[str, object]:
    ...
    for contract in contracts:
        ...
        if contract.market == "TW" and contract.dashboard_url != get_tw_dashboard_url():
