...
def validate() -> dict:
    ...
    checks = {
        ...
        "email_decision_content": all(marker in email for marker in ("Top opportunities", "No-trade / avoid", canonical_url)),
        "line_decision_content": all(marker in line for marker in ("Top 3", "Avoid", canonical_url)),
